              ...
              <div className="card mb-4 shadow-sm">
                <div className="card-body">
                  ...
                  <div className="row-md-4">
                    <button className="btn btn-warning" onClick={() => navigate(`/update/${book.id}`, { state: { id: book.id } })}>
                      Update
                    </button>
                    <button className="btn btn-danger" onClick={() => navigate(`/delete/${book.id}`, { state: { id: book.id } })}>
                      Delete
                    </button>
                  </div>
                </div>
